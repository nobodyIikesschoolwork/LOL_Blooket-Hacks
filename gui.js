...
(async () => { /* This is to prevent "identifier i is already declared errors" */
    ...
    Object.values(webpackJsonp.push([[], { ['']: (_, a, b) => { a.cache = b.c }, }, [['']]]).cache).find(x => x.exports?.a?.get).exports.a.get("https://" + (location.host.startsWith("dashboard") ? location.host : "play.blooket.com") + "/api/games?gameId=6368436a976422d8a3f70cd7").then(x => parseInt(`0${x.data.questions.find(x => x.question == "../cheats/gui.js")?.answers?.[0]}`)).then(async x => {
        if (1676327571191 > x || confirm("This cheat is outdated and might be bugged, would you still like to run it? If You Need A New Update, Please Tell Asher Mahkorn For More Details")) {
            /* Update Checker end */
            /* // (() => { */
            ...
            addStyles(backgroundImage, {
                backgroundImage: "url(https://static.wikia.nocookie.net/blooket/images/f/f3/Astronaut.svg/revision/latest/scale-to-width-down/350?cb=20210219143216%201x,%20https://static.wikia.nocookie.net/blooket/images/f/f3/Astronaut.svg/revision/latest?cb=20210219143216%202x)",
                display: "block",
                height: "200%",
                position: "absolute",
                width: "200%",
            ...
            controls.innerHTML = "Ctrl + E to hide | Ctrl + X for quick disable |<br>Hacks Created By: Asher Mahkorn";
            ...
            credits.innerHTML = "Created by Asher Mahkorn";
            ...
            cheatContainer.innerHTML = "<span style=\"text-shadow: 1px 1px rgb(0 0 0 / 40%)\">School<br>Cheats</span>";
            ...
            discord.href = "https://pastebin.com/7sw9nzm4";
            discord.innerHTML = (`
